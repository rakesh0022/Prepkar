            ...
            <Link key={t.href} href={t.href} style={{
              ...
              {on && (
                <div style={{
                  ...
                  borderRadius: 2, background: "linear-gradient(90deg, #2563EB, #0D9488)",
                }} />
              )}
              <span style={{ fontSize: 18, filter: on ? "none" : "grayscale(60%) opacity(0.45)", transition: "filter 0.2s" }}>{t.icon}</span>
