  ...
  return (
    <main style={{ minHeight: "100vh", background: "var(--bg)", paddingBottom: 80, paddingTop: 0 }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "28px 20px" }}>
        ...
        <h1 style={{ fontFamily: "'Playfair Display',serif", fontSize: 26, fontWeight: 700, color: "#111827", marginTop: 16, marginBottom: 8 }}>
          About NaukriYatra
        </h1>
        <p style={{ fontSize: 14, color: "#2563EB", fontWeight: 600, marginBottom: 24, fontFamily: "'Outfit'" }}>
