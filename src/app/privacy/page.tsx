...
export const metadata: Metadata = {
  ...
  description: "NaukriYatra privacy policy. How we collect, use, and protect your data.",
};

export default function PrivacyPage() {
  const sections = [
    { title: "Information We Collect", content: "When you create an account, we collect your name, email address, and practice session data (exam scores, test history). We also collect anonymous usage data such as pages visited, features used, and device type to improve our service." },
    { title: "How We Use Your Information", content: "Your information is used to provide and improve NaukriYatra services — storing your practice scores, showing your progress dashboard, sending exam date reminders (if opted in), and personalizing your experience. We never sell your personal data to third parties." },
    ...
    { title: "Cookies", content: "We use essential cookies for authentication (keeping you logged in) and analytics cookies (Google Analytics) to understand how our site is used. You can disable non-essential cookies in your browser settings." },
    ...
    { title: "Contact Us", content: "For privacy-related questions, email us at privacy@naukriyatra.com or visit our Contact page." },
  ];
  ...
  return (
    <main style={{ minHeight: "100vh", background: "var(--bg)", paddingBottom: 80, paddingTop: 0 }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "28px 20px" }}>
        ...
        <p style={{ fontSize: 13, color: "#9CA3AF", marginBottom: 28 }}>Last updated: April 2026</p>
